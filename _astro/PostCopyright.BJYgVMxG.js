import{j as c}from"./jsx-runtime.DtD2S6Vj.js";import{b as i,s as h}from"./config.f4At7k7_.js";import{c as v}from"./date.Dfx-CKFM.js";import{r as e}from"./index.C-7etoUd.js";import{B as m}from"./react-toastify.esm.CzcO4wKf.js";import"./clsx.B-dksMZM.js";const d=`<svg viewBox="0 0 242.1 124" height="50">
  <g>
...
</svg>`;function x(){return c.jsx("div",{className:"animated-signature",dangerouslySetInnerHTML:{__html:d}})}function p(t){return new URL(t,h.url).href}function b({title:t,slug:r,lastMod:n}){const[l,o]=e.useState(""),s=p(r);function a(){navigator.clipboard.writeText(s),m.success("已复制文章链接")}return e.useEffect(()=>{o(v(n))},[n]),c.jsxs("section",{className:"text-xs leading-loose text-secondary",children:[c.jsxs("p",{children:["文章标题：",t]}),c.jsxs("p",{children:["文章作者：",i.name]}),c.jsxs("p",{children:[c.jsxs("span",{children:["文章链接：",s]}),c.jsx("span",{role:"button",className:"cursor-pointer select-none",onClick:a,children:"[复制]"})]}),c.jsxs("p",{children:["最后修改时间：",l]}),c.jsx("hr",{className:"my-3 border-primary"}),c.jsxs("div",{children:[c.jsx("div",{className:"float-right ml-4 my-2",children:c.jsx(x,{})}),c.jsxs("p",{children:["商业转载请联系站长获得授权，非商业转载请注明本文出处及文章链接，您可以自由地在任何媒体以任何形式复制和分发作品，也可以修改和创作，但是分发衍生作品时必须采用相同的许可协议。",c.jsx("br",{}),"本文采用",c.jsx("a",{className:"hover:underline hover:text-accent underline-offset-2",href:"https://creativecommons.org/licenses/by-nc-sa/4.0/deed.zh",target:"_blank",rel:"noopener noreferrer",children:"CC BY-NC-SA 4.0"}),"进行许可。"]})]})]})}export{b as PostCopyright};
